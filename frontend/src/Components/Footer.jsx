...
import { updateInfo } from "../actions/updateAction";
...
function Footer(props) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const info = await getFetch("/info");
      dispatch(updateInfo(info));
      setSiteInfo(info);
      const pages = await getFetch("/page");
      setPages(pages);
    };
      ...
      <div className="main-footer widgets-dark typo-light">
        <div className="container">
          <div className="row">
              ...
              <div className="widget no-box">
                ...
                <ul className="thumbnail-widget">
                  <li>
                    {pages.map((answer) => {
                      return (
                        <div key={answer.link} className="thumb-content">
                          <a href={"/page/" + answer.link}>{answer.title}</a>
                        </div>
                      );
                    })}
                  </li>
            ...
            <div className="col-xs-12 col-sm-6 col-md-3">
              <div className="widget no-box"></div>
            </div>
            ...
            <div className="col-xs-12 col-sm-6 col-md-3">
              ...
              <ul className="social-footer2">
                <li className={siteInfo.youtubeURL === "" ? "d-none" : ""}>
                  <a
                    title="youtube"
                    target="_blank"
                ...
                <li className={siteInfo.facebookURL === "" ? "d-none" : ""}>
                  <a
                ...
                <li className={siteInfo.twitterURL === "" ? "d-none" : ""}>
                  <a
                ...
                <li className={siteInfo.instagramURL === "" ? "d-none" : ""}>
                  <a
                    title="instagram"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                <br></br>
                <p>
                  Copyright {siteInfo.sitename} © {new Date().getFullYear()}.
                </p>
              </div>
            </div>
          </div>
