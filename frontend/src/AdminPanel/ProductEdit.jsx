    ...
    <CCard className="container">
      ...
      <CCardBody>
        ...
        >
          <CFormGroup row>
            <CCol md="3">
              <CLabel htmlFor="text-input">Product Link</CLabel>
            </CCol>
            <CCol xs="12" md="9">
              <CInput
                id="text-input"
                name="text-input"
                placeholder="Product Link (ex. california-gold-nutrition-mct-oil-ml)"
              />
              <CFormText>
                The link of the product, can be found from store url bar.
              </CFormText>
            </CCol>
